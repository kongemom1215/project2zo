...
<!--주문자정보입력       -->
   <div>
      <br>
<!-- 전체입력값 form 으로 보내기 -->
<form action="orderResult.do?sum=${sum}" method="post" name="frm" onsubmit="return send_it();">
      <br>
         ...
         <c:otherwise>
            ...
            <c:forEach var="arr" items="${list }">
             <tr value="${list}" class="cart_tr" >
               ...
               <td style="width: 300px;" class="cart_td"><h4>${arr.pname}</h4></td>
            ...
            <tr class="info_tr">
               ...
               <td align="right" colspan="5">예상 결제 상품 총액 :</td>
      ...
      <table class="info" >
         ...
         <tr class="info_tr" height="20px" >
            ...
            <td>
               ...
               <input type="tel" name="buyerTel" value="${user.scontact }"  class="input_info" pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}">
...
<!--신용카드            -->
    <div id="showHide1" align="middle" style="display: none;">
      ...
      <table class="info" name="credit_tb">
         ...
         <tr  class="info_tr">
            <td>비밀번호</td>
            <td><input type="password" class="input_info" name="creditPass" size="4" ></td>
