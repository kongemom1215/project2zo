...
<hr>
	...
	<div class="main">
		<div>
			<table style="width:60%; height: 100px; margin: auto; text-align: center; border: 0px;">
				<tr>
					<td><input type="button" class="member_button" onclick="location.href='memberAdminPage.do'"> </td>
					<td><input type="button" class="product_button"> </td>
				...
				<tr>
					...
					<td><input type="button" value="상품 관리" class="admin_button"></td>
