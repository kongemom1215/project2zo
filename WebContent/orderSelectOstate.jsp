						...
						<tr>
							<td class="1" style="text-align=center;" colspan="3">
								<select name="ostate" id="ostate" onchange="selectOstate(this)">
									...
									<option value="6"<c:if test="${ostate eq '6' }">selected="seleted"</c:if>>리뷰 완료</option>
								</select>
							</td>
						</tr>
						<tr>
					...
					<table id="search_table">
						...
						<c:forEach var="order" items="${orderlist }">
							<tr>
								...
								<td><a href="orderSelectInfo.do?oid=${order.oid }&ostate=${ostate}"> <fmt:formatDate pattern="yyyyMMdd" value="${order.odate }"/>
