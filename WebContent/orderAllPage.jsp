...
<link rel="stylesheet" type="text/css" href="css/order2.css?ver=24">
					...
					<table id="search_table">
						...
						<c:forEach var="order" items="${orderlist }">
							<tr>
								...
								<td><a href="orderSelectInfo.do?oid=${order.oid }"> <fmt:formatDate pattern="yyyyMMdd" value="${order.odate }"/>
