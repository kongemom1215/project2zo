...
public class ProductDao {
	...
	public Product getDetailInfo(int pid) throws Exception {
		...
		try {
			...
			if (rs.getString("col4") == null || rs.getString("col4").equals("null")) {
				prdt.setCol4("");
			} else {
				prdt.setCol4(rs.getString("col4"));
			}

			if (rs.getString("col5") == null || rs.getString("col5").equals("null")) {
				prdt.setCol5("");
			} else {
				prdt.setCol5(rs.getString("col5"));
			}

			System.out.println(rs.getString("col1"));
			System.out.println(rs.getString("col2"));
			System.out.println(rs.getString("col3"));
			System.out.println(rs.getString("col4"));
			System.out.println(rs.getString("col5"));
